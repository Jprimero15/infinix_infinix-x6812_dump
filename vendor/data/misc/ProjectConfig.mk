...
#BSP: add 1st-lcm_drv XLBYEHLJYE-3 by baofu.zhang 20210426 start
BOOT_LOGO = fhdplus2460
#BSP: add 1st-lcm_drv XLBYEHLJYE-3 by baofu.zhang 20210426 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add project macro by wanghanfeng 20210415 start
CUSTOM_BUILD_VERNO = CY-X6812-H6912-A
#BSP: add project macro by wanghanfeng 20210415 start
...
#BSP: add XLBYEHLJYE-1 by bin.peng for x6812 P1 bringup 20210425 start
CUSTOM_HAL_MSENSORLIB = mmc5603_x6812 qmc6308_x6812
TRAN_SINGLE_ALS_CALI = yes
VIRTUAL_GYROSCOPE_ALGORITHM = yes
CUSTOM_KERNEL_SENSORHUB = yes
#BSP: add XLBYEHLJYE-1 by bin.peng for x6812 P1 bringup 20210425 end
#ITD:modify by camera driver team start
CUSTOM_HAL_IMGSENSOR = s5kjn1_mipi_raw s5kjn1ext2_mipi_raw gc08a3_mipi_raw gc8034_mipi_raw gc02m1b_mipi_raw ov02b1b_mipi_raw gc6153_serial_yuv pblcs5kjn1_mipi_raw pblcs5kjn1ext2_mipi_raw pblcgc08a3_mipi_raw pblcgc8034_mipi_raw pblcgc02m1b_mipi_raw pblcov02b1b_mipi_raw pblcgc6153_serial_yuv
CUSTOM_HAL_MAIN2_IMGSENSOR = gc02m1b_mipi_raw ov02b1b_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5kjn1_mipi_raw s5kjn1ext2_mipi_raw
CUSTOM_TRAN_HAL_MAIN3_IMGSENSOR = gc6153_serial_yuv
CUSTOM_HAL_SUB_IMGSENSOR = gc08a3_mipi_raw gc8034_mipi_raw
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5kjn1_mipi_raw s5kjn1ext2_mipi_raw gc08a3_mipi_raw gc8034_mipi_raw gc02m1b_mipi_raw ov02b1b_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kjn1_mipi_raw s5kjn1ext2_mipi_raw
#ITD:modify by camera driver team end
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_SUB_IMGSENSOR = gc08a3_mipi_raw gc8034_mipi_raw
#ITD:modify by camera driver team end
...
#TDD: modify modem P1 checklist by xiaoshi.guo 20210425 start
CUSTOM_MODEM = x6812_h6912_a1
#TDD: modify modem P1 checklist by xiaoshi.guo 20210425 end
...
#BSP: modify audio bring up XLBYEHLJYE-7 xinyu.zhao 20210428 start
MTK_AUDIO_NUMBER_OF_MIC = 1
MTK_AUDIO_NUMBER_OF_SPEAKER = 2
MTK_AUDIO_SPEAKER_PATH = int_hp_buf
#BSP: modify audio bring up XLBYEHLJYE-7 xinyu.zhao 20210428 end
...
#ITD:add cam 3pty function by yu.wang 20210510 start
MTK_CAM_HDR_SUPPORT = no
#ITD:add cam 3pty function by yu.wang 20210510 end
...
#TDD：modify CMSFTASK-22 by xiaoshi.guo 20201202 start
MTK_EXTERNAL_SIM_ONLY_SLOTS = 4
MTK_EXTERNAL_SIM_SUPPORT = yes
MTK_EXTERNAL_SIM_RSIM_ENHANCEMENT = yes
#TDD：modify CMSFTASK-22 by xiaoshi.guo 20201202 end
...
MTK_FM_SUPPORT = yes
#NFBD:add LNA support TSDT-151 by tieshan.huang 20210706 start
MTK_FM_GPIO_FUNC = yes
#NFBD:add LNA support TSDT-151 by tieshan.huang 20210706 end
...
#BSP:modify XLBYEHLJYE-194 by baofu.zhang 20210521 start
MTK_HIGH_FRAME_RATE = yes
MTK_HIGH_FRAME_RATE_DEFAULT_FPS = 90
#BSP:modify XLBYEHLJYE-194 by baofu.zhang 20210521 end
...
#BSP:modify jeita function XLJLHLJY-1249 by fan.hong 20201010 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP:modify jeita function XLJLHLJY-1249 by fan.hong 20201010 end
MTK_K64_SUPPORT=yes
...
#BSP: add for XLELHLES-7 by shentao.yang 20190820 start
TRAN_USE_CUSTOM_FS = yes
TRAN_USE_F2FS = yes
#BSP: add for XLELHLES-7 by shentao.yang 20190820 end
MTK_CAM_ISPHIDL_SUPPORT = yes
#BSP: add project clone format by wanghanfeng 20210415 start
...
#BSP: add project clone format by wanghanfeng 20210415 end
#SDD: add project sw version by jiangping.guo 20210415 start
MTK_BUILD_VERNO=X6812-H6912ABCGHIJ-R-GL-220110V569
TRAN_FINGERPRINT_BUILD_VERNO=220110V569
#SDD: add project sw version by jiangping.guo 20210415 end
#BSP: add project macro by wanghanfeng 20210415 start
CUSTOM_TRAN_PROJECT=tran_x6812
CUSTOM_TRAN_BOM=tran_x6812_a1
#BSP: add project macro by wanghanfeng 20210415 end
